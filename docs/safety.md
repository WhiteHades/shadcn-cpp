...
Qt's [object ownership documentation](https://doc.qt.io/qt-6/objecttrees.html) explains the parent tree and rules for stack lifetimes. [QObject documentation](https://doc.qt.io/qt-6/qobject.html) defines connection and thread affinity behaviour.
