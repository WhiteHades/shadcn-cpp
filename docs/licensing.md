...
The native source does not bundle fonts or Lucide SVGs. Applications supply their own QIcon assets and font selection. Any future copied asset or dependency source needs its own attribution and licence review.

The port is independent of shadcn/ui. The project name describes the intended compatibility work and must not imply upstream endorsement.
