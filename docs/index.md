...
The current snapshot contains a tested Qt-free core and ten draft widgets. Their native build and visual parity remain unverified. Read the [verification report](verification.md) before integrating the widgets into an application.
